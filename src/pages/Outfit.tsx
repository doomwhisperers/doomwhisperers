            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                ...
                <ul className="space-y-3 text-doom-silver/80">
                  <li className="font-im-fell">• Czarna czapka jesienne liście</li>
                  <li className="font-im-fell">• Kamizelka z fioletową koszulą</li>
                  <li className="font-im-fell">• Czarne dżinsy jesienne liście</li>
                  <li className="font-im-fell">• Buty turystyczne sunset trails</li>
                </ul>

                <ul className="space-y-3 text-doom-silver/80">
                  <li className="font-im-fell">• Ogłowie angielskie lawendowe sny</li>
                  <li className="font-im-fell">• Czarne klasyczne siodło do skoków przez przeszkody</li>
                  <li className="font-im-fell">• Wyścigowy fioletowy czaprak</li>
                  <li className="font-im-fell">• Fioletowa wstążka na ogon</li>
                </ul>
              </div>
